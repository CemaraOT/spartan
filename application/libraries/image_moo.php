...
class Image_moo
{
	...
	//----------------------------------------------------------------------------------------------------------
	{
        ...
        public function set_dest_x($dest_x) {
            $this->dest_x   = $dest_x ;
            return $this ;
        }
        
        public function set_dest_y($dest_y) {
            $this->dest_y   = $dest_y ;
            return $this ;
        }
	...
	//----------------------------------------------------------------------------------------------------------
	{
		...
		else
		{
			...
			switch ($position)
			{
                ...
                $dest_x = !empty($this->dest_x) ? $this->dest_x : $dest_x ;
                $dest_y = !empty($this->dest_y) ? $this->dest_y : $dest_y ;
